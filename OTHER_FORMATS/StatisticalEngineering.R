...
system(paste("pdftocairo -svg", out_pdf))
eqn_pic <- grImport2::readPicture(file.path(temp_dir, "StatEng_eqn.svg"))
...
sticker(
  ...
  h_fill = "#FFFFFF",
  h_color = "#1881C2",
  filename = "StatisticalEngineering.svg",
  dpi = 300
)

image_write(
  image_read_svg("StatisticalEngineering.svg", width = 1200),
  path = "StatisticalEngineering.png"
  )
